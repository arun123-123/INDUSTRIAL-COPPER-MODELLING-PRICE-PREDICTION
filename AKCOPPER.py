...
try:
    ...
    if selected == "Home":
        ...
        with col2:
            st.image(Image.open(r"C:\Users\HP\Downloads\Copper Nickel Flange Supplier_ Your Ultimate Guide.jpg"), width=500)
            st.image(Image.open(r"C:\Users\HP\Downloads\Best-in-Class Copper Story Inks Deal with Indonesia.jpg"),width=500)
